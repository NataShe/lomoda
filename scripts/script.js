...
let hash = location.hash.substring(1); //отрезаем ненужную #, например, в #men
...
//переносим ниже, тк addEventListener - это вызовы функции, они должны находиться под функцией
...
try {
  ...
  console.warn(err); //будет выделять жёлтым
}
